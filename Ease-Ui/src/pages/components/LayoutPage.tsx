...
// export const Layout = ({ header, sidebar, children, footer }) => {
//   return (
//     <div className="flex flex-col min-h-[400px] w-full border rounded-xl overflow-hidden">
//       {header && <header className="border-b px-4 py-3">{header}</header>}
//       <div className="flex flex-1 overflow-hidden">
//         {sidebar && <aside className="w-48 border-r p-4">{sidebar}</aside>}
...
//   const propsData = [
//     { prop: "header", type: "React.ReactNode", default: "undefined", description: "Header content rendered at the top of the layout." },
//     { prop: "sidebar", type: "React.ReactNode", default: "undefined", description: "Sidebar content rendered on the left side." },
//     { prop: "children", type: "React.ReactNode", default: "required", description: "Main content rendered in the center body." },
//     { prop: "footer", type: "React.ReactNode", default: "undefined", description: "Footer content rendered at the bottom." },
//   ];
...
//           A modular structural layout wrapper featuring configurable header, sidebar, body, and footer areas.
//         </p>
//       </div>
...
//           <Layout
//             header={<div className="font-semibold text-sm">Dashboard Header</div>}
//             sidebar={
...
//               </ul>
//             }
//             footer={<div>Dashboard Footer © 2026</div>}
//           >
//             <div className="space-y-2">
//               <h2 className="text-lg font-bold">Main Content Area</h2>
//               <p className="text-sm text-gray-600 dark:text-gray-400">
//                 This is where your primary page content and components will be rendered dynamically.
//               </p>
//             </div>
//           </Layout>
//         </div>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 flex flex-col">
      ...
      <header className="h-16 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-6 flex items-center justify-between sticky top-0 z-30">
        <div className="flex items-center gap-4">
          ...
          <span className="font-bold text-xl tracking-tight bg-gradient-to-r from-indigo-500 to-violet-500 bg-clip-text text-transparent">
            EaseUi Pro
          </span>
        </div>
          ...
          <div className="flex h-56">
            ...
            <div className="flex-1 flex flex-col bg-gray-50/50 dark:bg-gray-900/50">
              ...
              <div className="flex-1 flex items-center justify-center p-6 text-xs text-gray-400 dark:text-gray-500">
                Advanced Layout Canvas Content Area
              </div>
            </div>
          </div>
        </div>
